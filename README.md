...
All the C code has been compiled using gcc with '-std=c99 -Wall -Wextra -W -Wpedantic -Werror -g' options so it is extremely strict and will force absolutely clean C99 code (compilation is rejected at the slightest imperfection).
